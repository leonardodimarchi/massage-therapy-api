...
export class addUserAndAppointments1674593672019 implements MigrationInterface {
    name = 'addUserAndAppointments1674593672019'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "addresses" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created_at" text NOT NULL DEFAULT (datetime('now')), "updated_at" text NOT NULL DEFAULT (datetime('now')), "postalCode" varchar(8) NOT NULL, "state" varchar(512) NOT NULL, "city" varchar(512) NOT NULL, "neighborhood" varchar(512) NOT NULL, "houseNumber" integer NOT NULL, "userId" integer NOT NULL)`);
