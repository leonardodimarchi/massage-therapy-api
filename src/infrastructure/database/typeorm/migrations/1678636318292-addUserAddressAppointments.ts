...
export class addUserAddressAppointments1678636318292 implements MigrationInterface {
    name = 'addUserAddressAppointments1678636318292'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "addresses" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created_at" text NOT NULL DEFAULT (datetime('now')), "updated_at" text NOT NULL DEFAULT (datetime('now')), "postalCode" varchar(8) NOT NULL, "state" varchar(512) NOT NULL, "city" varchar(512) NOT NULL, "street" varchar(1024) NOT NULL, "neighborhood" varchar(512) NOT NULL, "houseNumber" integer NOT NULL, "userId" integer NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created_at" text NOT NULL DEFAULT (datetime('now')), "updated_at" text NOT NULL DEFAULT (datetime('now')), "email" varchar(512) NOT NULL, "name" varchar(1024) NOT NULL, "password" varchar(512) NOT NULL, "birthDate" datetime NOT NULL, "phone" varchar(50) NOT NULL, "gender" varchar CHECK( "gender" IN ('male','female') ) NOT NULL, "diseaseHistory" varchar(1024), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"))`);
