...
export class UserAndAppointments1669947327927 implements MigrationInterface {
    name = 'UserAndAppointments1669947327927'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created_at" text NOT NULL DEFAULT (datetime('now')), "updated_at" text NOT NULL DEFAULT (datetime('now')), "email" varchar(50) NOT NULL, "name" varchar(50) NOT NULL, "password" varchar(50) NOT NULL, "birthDate" datetime NOT NULL, "phone" varchar(50) NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"))`);
